...
% 去掉图表号后面的:
% 图表标题字体为11pt, 这里写作大五号
\renewcommand{\captionfont}{\sLargeWuhao}
% 定义缩放标准
\def\gs{1.0}
%------------------------------------------------------------------------------%
...
\titleformat{\chapter}[hang] {\normalfont\sSanhao\filcenter\fHei\sf}
...
\renewcommand{\headrule}{%
    {
        \if@fancyplain\let\headrulewidth\plainheadrulewidth
        \fi\makeheadrule
    }
}
...
% 后续文字可以自行修改
\chead{\sSanhao\raisebox{0.04cm}{\fNWPU 西北工业大学} \fSong \bfseries{本科毕业设计英文翻译}}
%------------------------------------------------------------------------------%
...
\DeclareMathOperator\diff{d\!}  % diff operator
\DeclareMathOperator\Diff{D\!}  % Diff operator
\DeclareMathOperator\lcm{lcm}   % lcm operator
